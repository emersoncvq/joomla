...
class AllVideoShareViewPlayers extends AllVideoShareView {
    ...
    public function display( $tpl = null ) {
		...
		JToolBarHelper::title( JText::_( 'ALL_VIDEO_SHARE' ), 'equalizer' );
	...
	public function add( $tpl = null ) {
		...
		JToolBarHelper::title( JText::_( 'ADD_NEW_PLAYER_PROFILE' ), 'equalizer' );
	...
	public function edit( $tpl = null ) {
		...
		JToolBarHelper::title( JText::_( 'EDIT_THE_PLAYER_PROFILE' ), 'equalizer' );
		JToolBarHelper::save( 'save', JText::_( 'SAVE' ) );
        JToolBarHelper::apply( 'apply', JText::_( 'APPLY' ) );
        JToolBarHelper::cancel( 'cancel', JText::_( 'CANCEL' ) );

...
Object.assign(MediaElementPlayer.prototype, {
    ...
    buildme( player, controls, layers, media ) {
		const t = this;		
		...
		if( t.validate( t.options.pluginPath, t.options.licenseKey ) ) {
			...
			player.meLayer.innerHTML = '<a href="https://allvideoshare.mrvinoth.com/" target="_blank" style="position:absolute; padding:5px 6px; background-color:#f89406; color:#fff; font-family:\'Trebuchet MS\'; font-size:14px; text-decoration:none; top:10px; right:10px; z-index:9999999; cursor:pointer;">Invalid License Key</a>';
		}
		
		layers.insertBefore( player.meLayer, layers.querySelector( `.${t.options.classPrefix}overlay-play` ) );
    },
	
	validate( domain, license ) {		
		const t = this;	
